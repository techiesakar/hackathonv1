...
export default class ThingsToDo extends Component {
  render() {
    ...
    return (
      <div className="todo">
        <div className=" container todo-wrapper mx-auto rounded">
          <Slider {...settings}>
            <div className="mountain todo-item">
              <div className="todo-item-content">
                ...
                <p>
                  ...
                  From the remotest corners to the urban landscape, Nepal
                  embodies a sensory experience of colours, sounds, sights and
                  tastes. Visit Nepal welcomes you to life’s amazing moments.
                </p>
